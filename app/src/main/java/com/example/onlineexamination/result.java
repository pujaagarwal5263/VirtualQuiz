...
public class result extends AppCompatActivity {
    ...
    int marks;
    EditText attemptEdit,correctEdit,wrongEdit,marksEdit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        attemptEdit = findViewById(R.id.attemptEdit);
        correctEdit = findViewById(R.id.correctEdit);
        wrongEdit = findViewById(R.id.wrongEdit);
        marksEdit = findViewById(R.id.marksEdit);
